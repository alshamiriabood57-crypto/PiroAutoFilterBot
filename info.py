...
API_ID = int(environ.get('API_ID', '22417964'))
API_HASH = environ.get('API_HASH', '153755c2bd889b23a9d9e73dc01afc49')
BOT_TOKEN = environ.get('BOT_TOKEN', '8508633803:AAE3N5bE7fX4aNsCNKhZph-DhUiq6SuJQbU')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7124506900').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003706877847').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ali:Ali2026Pass@cluster0.esdu8gs.mongodb.net/?appName=Cluster0")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',-1003715989741))
